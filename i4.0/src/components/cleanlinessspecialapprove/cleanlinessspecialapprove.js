...
class Cleanlinessspecialapprove extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  sendDataToBackend = async () => {
    ...
    const result = await httpClient.get(
      server.cleanlinessspecialsendData_URL +
      "/" +
  ...
  doGetMailrequest = async () => {
    try {
      const result = await httpClient.get(
        server.Mailrequest_URL + "/" + this.state.docNo// เปลี่ยน
      );
      ...
      // อัปเดต textValueModelNametb ให้มีค่าเท่ากับ this.state.report1
      if (Array.isArray(result.data.result) && result.data.result.length > 0) {
        this.setState({ textValueTextBoxmail: result.data.result[0].Mailrequest }); // เปลี่ยน
      } else {
        this.setState({ textValueTextBoxmail: '' }); // เปลี่ยน
      }
    } catch (error) {
      // แสดงข้อผิดพลาด (optional)
      console.error(error);
  ...
  doGetMgrequest2 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest2_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest3 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest3_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest4 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest4_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest5 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest5_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest6 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest6_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest7 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest7_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest8 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest8_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest9 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest9_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest10 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest10_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest11 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest11_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest12 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest12_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest13 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest13_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequest14 = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequest14_URL +
        "/" +
        this.state.textValueMgrequesttextbox +
        "/" +
        this.state.selectedOptionRadioButtons3 +
  ...
  doGetMgrequestresult = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequestresult_URL + "/" + this.state.docNo + "/" + this.state.textValueTextBoxmail // เปลี่ยน
      );
      ...
      // อัปเดต textValueModelNametb ให้มีค่าเท่ากับ this.state.report1
      if (Array.isArray(result.data.result) && result.data.result.length > 0) {
        this.setState({ selectedOptionRadioButtons3: result.data.result[0].Mgrequester_result }); // เปลี่ยน
      } else {
        this.setState({ selectedOptionRadioButtons3: '' }); // เปลี่ยน
      }
  ...
  doGetMgrequestreason = async () => {
    try {
      const result = await httpClient.get(
        server.Mgrequestreason_URL + "/" + this.state.docNo// เปลี่ยน
      );
      ...
      // อัปเดต textValueModelNametb ให้มีค่าเท่ากับ this.state.report1
      if (Array.isArray(result.data.result) && result.data.result.length > 0) {
        this.setState({ textValueMgrequesttb: result.data.result[0].Mgrequester_reason }); // เปลี่ยน
      } else {
        this.setState({ textValueMgrequesttb: '' }); // เปลี่ยน
      }
        ...
        didOpen: async () => {
          ...
          try {
            await Promise.all([
              ...
              this.doGetCommitted(),
              this.doGetMgrequestresult(),
              this.doGetMgrequestreason(),
              ...
              <div className="row-mb-12" style={{ paddingTop: 50 }}>
                ...
                <div
                  ...
                  <button
                    ...
                    onClick={async () => {
                      try {
                        const isSuccess = await this.doGetMgrequest();
                        const isSuccess2 = await this.doGetMgrequest2();
                        const isSuccess3 = await this.doGetMgrequest3();
                        const isSuccess4 = await this.doGetMgrequest4();
                        const isSuccess5 = await this.doGetMgrequest5();
                        const isSuccess6 = await this.doGetMgrequest6();
                        const isSuccess7 = await this.doGetMgrequest7();
                        const isSuccess8 = await this.doGetMgrequest8();
                        const isSuccess9 = await this.doGetMgrequest9();
                        const isSuccess10 = await this.doGetMgrequest10();
                        const isSuccess11 = await this.doGetMgrequest11();
                        const isSuccess12 = await this.doGetMgrequest12();
                        const isSuccess13 = await this.doGetMgrequest13();
                        const isSuccess14 = await this.doGetMgrequest14();

                        if (isSuccess || isSuccess2 || isSuccess3 || isSuccess4 || isSuccess5 || isSuccess6 || isSuccess7 || isSuccess8 || isSuccess9 || isSuccess10 || isSuccess11 || isSuccess12 || isSuccess13 || isSuccess14) {
                          Swal.fire({
                            icon: 'success',
                            title: 'Success',
...
export default Cleanlinessspecialapprove;
