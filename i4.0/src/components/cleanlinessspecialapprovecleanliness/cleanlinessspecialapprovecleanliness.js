...
class cleanlinessspecialapprovecleanliness extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  doGetCleanlinessapproveresult = async () => {
    try {
      const result = await httpClient.get(
        server.Cleanlinessapproveresult_URL + "/" + this.state.docNo  + "/" + this.state.textValueTextBoxmail// เปลี่ยน
      );
          ...
          <div className="row-mb-12" style={{ paddingTop: 50 }}>
            ...
            <div
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    const isSuccess = await this.doGetCleanlinessapprove();
                    const isSuccess2 = await this.doGetCleanlinessapprove2();
                    const isSuccess3 = await this.doGetCleanlinessapprove3();
                    const isSuccess4 = await this.doGetCleanlinessapprove4();
                    const isSuccess5 = await this.doGetCleanlinessapprove5();
                    const isSuccess6 = await this.doGetCleanlinessapprove6();
                    const isSuccess7 = await this.doGetCleanlinessapprove7();
                    const isSuccess8 = await this.doGetCleanlinessapprove8();
                    const isSuccess9 = await this.doGetCleanlinessapprove9();
                    const isSuccess10 = await this.doGetCleanlinessapprove10();
                    const isSuccess11 = await this.doGetCleanlinessapprove11();
                    const isSuccess12 = await this.doGetCleanlinessapprove12();
                    const isSuccess13 = await this.doGetCleanlinessapprove13();
                    const isSuccess14 = await this.doGetCleanlinessapprove14();
...
export default cleanlinessspecialapprovecleanliness;
