...
import { key, server,Url,apiUrl } from "../../constants";
...
class ViewdatabaseUser extends Component {
  constructor(props) {
    super(props);
  ...
  renderReport10 = () => {
    if (this.state.report10 && this.state.report10.length > 0) {
      return this.state.report10.map((item, index) => (
        ...
        <td>{item.MSL_accept_date}</td>          
        <td>{item.MSL_check_point_date}</td>
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-6">
                  <h1>Database Analysis Requester</h1>
                </div>
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-right">
                    ...
                    <li className="breadcrumb-item active">Database Analysis Requester</li>
                  </ol>
                </div>
              </div>
            </div>
                      ...
                      <div className="col-sm-1">
                        <label>
                          <input
                            ...
                            name="requestType"
                            value="FA"
                            onChange={this.handleRadioChangeview}
                          />
                          FA req.
                        </label>
                      </div>
...
export default ViewdatabaseUser;
