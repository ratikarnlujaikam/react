...
class ROTOR extends Component {
  ...
  doGetDataDay = async () => {
    ...
    for (let index = 0; index < resultday.data.resultAVGday.length; index++) {
      ...
      for (let index1 = 0; index1 < resultday.data.controlLimit.length; index1++) {
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-6">
                  <h1>SPC Chart Rotor Factory 2</h1>
                </div>
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-right">
                    ...
                    <li className="breadcrumb-item active">Rotor</li>
                  </ol>
                </div>
              </div>
            </div>
