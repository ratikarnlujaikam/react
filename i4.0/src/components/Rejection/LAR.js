...
class LAR extends Component {
  ...
  doGetDataReport = async () => {
    const result = await httpClient.get(
      server.LAR_URL + "/" + this.state.year + "/" + this.state.Month[0].label
    );
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          ...
                          Swal.fire({
                            ...
                            if (this.state.report.length > 0) {
                              if (this.state.report[0].TOTAL.length > 0) {
                                Swal.fire({
                                  icon: "success",
                                  title: "Success",
                                ...
                                this.state.report[0].TOTAL.length == 0
                              ) {
                                Swal.fire({
                                  icon: "error",
